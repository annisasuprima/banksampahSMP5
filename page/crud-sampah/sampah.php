...
<body>
	...
	$result = mysqli_query($conn, "SELECT sampah.* , jenis_sampah.nama_jenis FROM  sampah  JOIN jenis_sampah ON sampah.kode_jenis=jenis_sampah.kode_jenis");
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title" style="flex: 1;">Daftar Sampah</h4>
										<div>
											...
											?>
												...
												<button class="btn btn-primary btn-round ml-auto" data-toggle="modal" style="margin:unset">
													...
													<a href="tambah-sampah.php" class="button is-primary" style="color:white !important; text-decoration:none;" class="fa fa-plus">
										...
										<table id="add-row" class="display table table-striped table-hover">
											...
											<tbody>
												...
												?>
													<tr>
														<td><?php echo $no++; ?></td>
														<td><?php echo $user_data['kode_sampah']; ?></td>
											...
											?>
														<td>
															...
															<a href="edit-sampah.php?kode_sampah=<?php echo $user_data['kode_sampah']; ?>" class="btn btn-primary btn-sm mr-1 mx-1"><i class="fa fa-edit"></i></a>
															<a href="del-sampah.php?kode_sampah=<?php echo $user_data['kode_sampah']; ?>" class="btn btn-danger btn-sm mr-1 mx-2"><i class="fa fa-trash"></i></a>
