...
<body>
  ...
  $result = mysqli_query($conn, "SELECT tarik.* , nasabah.nama_kelas FROM  tarik  JOIN nasabah ON tarik.kode=nasabah.kode JOIN tabungan ON tarik.kode_tabungan=tabungan.kode_tabungan");
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title" style="flex: 1;">Daftar Tarikan</h4>
										<div>
											<button class="btn btn-primary btn-round ml-auto" data-toggle="modal" style="margin:unset">

												<a href="tambah-tarik.php" class="button is-primary" style="color:white !important; text-decoration:none;" class="fa fa-plus">
                          ...
                          <th>Tanggal Penarikan</th>
                            ...
                            <td><?php echo $user_data['tgl_tarik']; ?></td>
														...
														<td>
																...
																<a href="del-tarik.php?kode_tarik=<?php echo $user_data['kode_tarik']; ?>" class="btn btn-danger btn-sm mr-1 mx-2"><i class="fa fa-trash"></i></a>
