...
<body>
  ...
  // $result = mysqli_query($conn, "SELECT * FROM  sampah");
	...
	$query =  "SELECT tabungan.* , nasabah.nama_kelas FROM  tabungan JOIN nasabah ON tabungan.kode=nasabah.kode";
	if($isNasabah){

	$query = 	"SELECT tabungan.* , nasabah.nama_kelas FROM  tabungan JOIN nasabah ON tabungan.kode=nasabah.kode where nasabah.kode=". $_SESSION['id'];
	}
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Data Tabungan Nasabah</h4>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title" style="flex: 1;">Daftar Tabungan Nasabah</h4>
										<div>
                          ...
                          <th>Saldo</th>
                            ...
                            <td><?php echo $user_data['saldo']; ?></td>
													

														<td>

															<a href="riwayat-transaksi.php?kode_tabungan=<?php echo $user_data['kode_tabungan']; ?>" class="btn btn-primary btn-sm mr-1 mx-2">Riwayat Transaksi</a>
